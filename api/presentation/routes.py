...
from application.use_cases import get_equipament_data_googlesheet, get_parameter_data_googlesheet, get_analisys_data_googlesheet, get_equipment_data_database, get_analisys_data_database, get_parameter_data_database
...
def get_analisys():
    ...
    return jsonify(get_analisys_data_database())
